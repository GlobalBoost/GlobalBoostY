...
void Shutdown()
{
    ...
    RenameThread("globalboost-y-shutoff");
...
int main(int argc, char* argv[])
{
    ...
    // Connect globalboostyd signal handlers
    noui_connect();
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 8226 or testnet: 18226)") + "\n" +
...
{
    RenameThread("globalboost-y-loadblk");
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    // requested to kill globalboost-y-qt during the last operation. If so, exit.
